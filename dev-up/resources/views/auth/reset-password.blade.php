...
<head>
    ...
    <title>DEV↑UP - Reset Password</title>
...
<body class="min-h-screen flex items-center justify-center relative">
    ...
    <div class="relative z-10 w-full max-w-md px-6">
        ...
        <div class="text-center mb-8">
            ...
            <p class="text-gray-400 text-sm">Create a new secure password for your account.</p>
        </div>
                ...
                <div class="space-y-2">
                    ...
                    <div class="relative">
                        ...
                        <input 
                            ...
                            autocomplete="email"
                            readonly
                            class="input-field w-full pl-12 pr-4 py-4 rounded-xl text-white placeholder-gray-500 outline-none bg-gray-800/50">
                    </div>
                    @if ($errors->has('email'))
        ...
        <div class="text-center mt-12">
            <div class="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-gray-900/50 border border-gray-800">
                ...
                <span class="text-xs text-gray-500 mono-font">SECURE RESET</span>
            </div>
        </div>
    </div>
</body>
