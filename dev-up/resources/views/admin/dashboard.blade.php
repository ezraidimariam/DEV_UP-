        ...
        <div class="max-w-7xl mx-auto px-6 py-4">
            <div class="flex items-center justify-between">
                ...
                <div class="flex items-center gap-6">
                    <a href="/admin" class="nav-item px-4 py-2 rounded-xl text-white">
                        <i class="ri-dashboard-line mr-2"></i>
                        Admin Dashboard
                    </a>
                    <a href="{{ route('challenges.index') }}" class="nav-item px-4 py-2 rounded-xl text-gray-300">
        ...
        <div class="max-w-7xl mx-auto">
            ...
            <div class="glass-card rounded-2xl p-8">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                    <a href="{{ route('challenges.index') }}" class="nav-item p-6 rounded-xl text-white text-center">
                    ...
                    <a href="{{ route('formateur.dashboard') }}" class="nav-item p-6 rounded-xl text-white text-center">
                    ...
                    <a href="#" class="nav-item p-6 rounded-xl text-white text-center">
