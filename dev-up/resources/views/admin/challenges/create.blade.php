...
<head>
    ...
    <title>DEV↑UP - Create Challenge</title>
...
<body>
    ...
    <main class="max-w-7xl mx-auto px-6 py-20">
        <!-- Header -->
        <div class="mb-8">
            <h1 class="brand-font text-4xl font-bold gradient-text mb-2">Create New Challenge</h1>
            <p class="text-gray-400">Add a new challenge to the platform</p>
        </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div class="space-y-6">
                        ...
                        <div>
                            ...
                            <input type="text" name="title" required class="form-input" placeholder="Enter challenge title...">
                            @error('title')
                        ...
                        <div>
                            ...
                            <textarea name="description" rows="4" required class="form-input" placeholder="Describe the challenge..."></textarea>
                            @error('description')
                                <div class="text-red-400 text-sm mt-1">{{ $message }}</div>
                            @enderror
                        </div>
                    ...
                    <div class="space-y-6">
                        ...
                        <div>
                            ...
                            <input type="number" name="points" required min="1" max="1000" class="form-input" placeholder="Award points">
                            @error('points')
                                <div class="text-red-400 text-sm mt-1">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div>
                            ...
                            <input type="number" name="time_limit" required min="5" max="480" class="form-input" placeholder="Time limit in minutes">
                            @error('time_limit')
                                <div class="text-red-400 text-sm mt-1">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div>
                            ...
                            <textarea name="instructions" rows="6" required class="form-input" placeholder="Detailed instructions for completing the challenge..."></textarea>
                            @error('instructions')
                                <div class="text-red-400 text-sm mt-1">{{ $message }}</div>
                            @enderror
                        </div>
